...
- 微信版本更新后 PyWxDump 暂不支持当前偏移量；当前已知支持上限为微信 PC `3.9.12.55`，微信 `4.x / 4.1` 暂不支持。
...
- 确认微信 PC 版已经启动并完成登录。
- 如果你使用的是微信 `4.x / 4.1`，这可能是底层 PyWxDump 对新版微信的误判，不代表你真的没有启动微信。
- 当前版本已知支持上限为微信 PC `3.9.12.55`，微信 `4.x / 4.1` 暂不支持。

如果提示“检测到微信进程但无法读取密钥”：

- 右键以管理员身份运行程序。
- 确认微信已完全登录，不是扫码等待状态。
- 如果已经管理员运行仍失败，可能是微信版本不受当前 PyWxDump 偏移量支持；当前已知支持上限为微信 PC `3.9.12.55`。
